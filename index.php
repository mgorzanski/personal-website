					...
					<section class="about-me">
						<div class="row center-xs">
							<div class="col-lg-4 col-md-4 col-sm-4 col-xs-11 profile-image">
								<div class="box">
									<img class="image" src="images/profile.jpg" alt="Profile photo">
								</div>
							</div>
					...
					<section class="portfolio portfolio-space">
						...
						<div class="row portfolio-items">
							<div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 portfolio-item">
								<div class="box">
									<a class="portfolio-item-link" href="https://github.com/mgorzanski/2048/">
										<img class="portfolio-item-thumbnail image" src="images/portfolio/2048.png" alt="2048">
										<h4 class="portfolio-item-title">2048</h4>
									</a>
								</div>
							</div>
							<div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 portfolio-item">
								<div class="box">
									<a class="portfolio-item-link" href="/matgor4/portfolio/item/design-for-wordpress-com">
										<img class="portfolio-item-thumbnail image" src="images/thumbnail.jpg" alt="Design for wordpress.com">
