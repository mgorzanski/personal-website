                ...
                <div className="col-lg-8 col-md-8 col-sm-8 col-xs-12 profile-description">
                  <div className="box">
                    ...
                    <p className="about-me_text">
                      ...
                      since childhood, learning new things everyday. Currently
                      most of the time doing web development and trying new
                      things.
                    </p>
                    ...
                    <p className="about-me_text">
                      Do you want to contact me? Look{' '}
                      <Link to="/contact-me/">here</Link>.
                    </p>
                    <p className="about-me_text">
                      You can also check my GitHub{' '}
                      <a href="http://github.com/mgorzanski">here</a>.
                    </p>
                  </div>
                </div>
              </div>
